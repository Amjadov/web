...
Currently driving government process automation at EY and pursuing TOGAF Foundation certification to deepen enterprise architecture expertise. Track record of managing end-to-end project lifecycles, building high-performing teams, and delivering measurable business outcomes: 8× throughput gains, sub-200ms response times, and zero-downtime migrations.

Seeking senior leadership roles — Project/Program Manager, Enterprise Architect, or Head of IT — where I can apply my blend of strategic vision, architectural thinking, and hands-on delivery experience to drive organizational transformation at scale. 
...
**Project Manager | Government Process Automation** (Feb 2025 – Present) 	EY, Amman, Jordan
*Client: Saudi Expro – Services Efficiency Review Department*

Leading the end-to-end digital transformation of a government agency’s manual workflows, replacing fragmented legacy systems with a centralized, scalable platform. Managing a cross-functional team of 5 and reporting directly to client executives.
...
Provide ongoing technical consulting across multiple concurrent projects, overseeing architecture decisions, development standards, and delivery timelines.
...
**ERP Implementation Specialist** (2013 – 2017) 	Mahmoud Saleh Abbar, Jeddah, Saudi Arabia

*Technical Scope: SQL Server, .NET Applications, ERP Systems*

Led a company-wide ERP implementation across 5 cities and 450+ employees, while developing supporting .NET applications for management reporting.
...
**Senior Full Stack Developer** (2010 – 2013\)	Grant Thornton ME, Amman, Jordan

*Technical Scope: C# .NET, ASP.NET, SQL Server, JavaScript, Telerik*
...
**Senior Full Stack Developer** (2005 – 2010\)	Grant Thornton, Jeddah, Saudi Arabia

*Technical Scope: C# .NET, ASP.NET, SQL Server, JavaScript, Telerik*

Managed a development team of 2, coordinating with Grant Thornton SA and CGC UK leadership. Owned client relationship management, technical delivery, and cross-border collaboration with frequent travel to the UK.
...
*Additional experience as Full Stack Developer at Visual Soft, Jubail, Saudi Arabia*

**EDUCATION & CREDENTIALS**

**Bachelor’s Degree in Business Administration** | Applied Science University, Amman, Jordan
...
**Arabic**: Native ∙ **English**: Fluent (Professional Working Proficiency) ∙ **French**: Intermediate
